"""
Django settings for django_e2e_benchmarks.
...
from django_e2e_benchmarks.logging import LoggingConfigFactory
...
FIRST_PARTY_APPS = [
    "django_e2e_benchmarks.apps.Django_e2e_benchmarksConfig",
    "users.apps.UsersConfig",
]
if IS_TESTING:
    FIRST_PARTY_APPS += ["django_e2e_benchmarks.tests.test_app.apps.TestAppConfig"]
THIRD_PARTY_APPS = [
    "allauth",
    "allauth.account",
...
MIDDLEWARE = [
    "django_e2e_benchmarks.middleware.SecurityHeadersMiddleware",
...
ROOT_URLCONF = "django_e2e_benchmarks.urls"
    ...
    # Look inside the `templates/` subdirectory of each Django app.
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "django_e2e_benchmarks.context_processors.metadata",
            ],
        },
    },
]

WSGI_APPLICATION = "django_e2e_benchmarks.wsgi.application"
...
TEST_RUNNER = "django_e2e_benchmarks.test.TestRunner"
